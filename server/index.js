...
app.use(express.static(path.join(__dirname, '../pairing-system/dist/pairing-system')));
...
app.get('/*', (req, res) => {
    res.sendFile(path.resolve(path.join(__dirname, '../pairing-system/dist/pairing-system/index.html')))
})
